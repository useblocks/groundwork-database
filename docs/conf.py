...
latex_documents = [
    (master_doc, 'gwsql.tex', 'gwsql Documentation',
...
man_pages = [
    (master_doc, 'gwsql', 'gwsql Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'gwsql', 'gwsql Documentation',
     author, 'gwsql', 'One line description of project.',
     'Miscellaneous'),
]
